...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    team: [
      { id: 'm1', name: '周德友', role: 'PM', dept: '产品部', avatarColor: 'blue', phone: '138-0000-0001', email: 'chenjg@nhy.com' },
    ...
    phases: [
      {
        ...
        docs: [
          { name: '产品定义文档 V1.0', required: true, uploaded: true, uploader: '周德友', uploadTime: '2026-07-01' },
          { name: '技术可行性评估报告', required: true, uploaded: true, uploader: '孙浩然', uploadTime: '2026-07-08' },
          { name: '竞品分析报告', required: false, uploaded: true, uploader: '周德友', uploadTime: '2026-07-10' },
          { name: '商业模式画布', required: false, uploaded: true, uploader: '周德友', uploadTime: '2026-07-12' },
        ],
        reviewStatus: '已通过',
      },
      {
    ...
    feeds: [
      ...
      { id: 'f4', author: '周德友', role: 'PM', avatarColor: 'blue', time: '2026-08-21 20:15', tag: '风险', content: '清微 5326 芯片样品排期延后 1 周（原 8-20 改为 8-27），影响 2.5 版本启动；已同步刘志强，预案优先保 2.0 交付。' },
    ...
    assets: [
      { id: 'a1', name: '产品定义文档 V1.0.md', category: '文档', subCategory: '产品文档', uploader: '周德友', uploadTime: '2026-07-01', size: '48 KB', fileType: 'Markdown' },
      ...
      { id: 'a13', name: '产品 Demo-3min 介绍.mp4', category: '视频', uploader: '周德友', uploadTime: '2026-08-18', size: '58 MB', fileType: 'MP4', tags: ['领导汇报'] },
      { id: 'a14', name: '电子哨兵产品宣传手册.pdf', category: '手册', uploader: '周德友', uploadTime: '2026-08-20', size: '8.2 MB', fileType: 'PDF', tags: ['对外宣传'] },
      ...
      { id: 'a16', name: '领导汇报版-核心进展 1 页纸.pptx', category: '营销素材', subCategory: '汇报材料', uploader: '周德友', uploadTime: '2026-08-22', size: '4.8 MB', fileType: 'PPTX', tags: ['领导版'] },
    ],
    aiScenes: [
      {
        id: 's1',
